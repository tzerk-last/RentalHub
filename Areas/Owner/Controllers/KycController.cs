...
public class KycController : Controller
{
    ...
    public async Task<IActionResult> Upload(IFormFile document, IFormFile selfie)
    {
        ...
        _context.Notifications.Add(new Notification
        {
            ...
            Message   = approved
                ? "Tu identidad fue verificada. Ya puedes publicar inmuebles."
                : $"Tu verificacion fue rechazada: {reason}. Intenta de nuevo.",
            IsRead    = false,
            CreatedAt = DateTime.UtcNow
        });
        ...
        try
        {
            await _emailService.SendAsync(
                ...
                approved
                    ? $"<h2>Verificacion aprobada</h2><p>Hola {user.FullName}, tu identidad fue verificada. Ya puedes publicar inmuebles en RentalHub.</p>"
        ...
        if (approved)
            TempData["Success"] = "Identidad verificada. Ya puedes publicar inmuebles.";
        else
